...
insert into usuario (codigopucp,nombre,apellido,correopucp,idespecialidad,password,edad) values
('20190923','Marcelo','Rojas','a20190923@pucp.edu.pe',1,sha2('Robloxfan1!',256),19),
('20190506','Juan','Perez','a20190506@pucp.edu.pe',3,sha2('s0yb1caenIWEB95*',256),22),
('20192561','Diana','Barboza','a20192561@pucp.edu.pe',1,sha2('LAB10_Dificil',256),24),
('20183540','Maria','Mendoza','a20183540@pucp.edu.pe',1,sha2('MeGustaLaGelatina123*!',256),21),
('20159912','Kevin','Chavez','a20159912@pucp.edu.pe',4,sha2('!h0laComoesTas',256),27),
('20174812','Diego','Ludeña','a20174812@pucp.edu.pe',1,sha2('C1b3rs3gur!d4d',256),26),
('20170476','Rommy','Torres','a20170476@pucp.edu.pe',1,sha2('pr0FesorlUch*',256),26);
...
update usuario set status='silver' where codigopucp='20190923';
update usuario set status='gold' where codigopucp='20192561';
update usuario set status='platinum' where codigopucp='20183540';
